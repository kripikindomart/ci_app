...
INSERT INTO `user` (`id_user`, `username`, `password`, `id_role`, `is_active`) VALUES (1, 'Admin', '$2y$10$/u1uYzIWiaAYIDdPWfuCke3tmdEcz8hdL/zondOXnp9UJ1zsPwF4W', 1, 1);
INSERT INTO `user` (`id_user`, `username`, `password`, `id_role`, `is_active`) VALUES (3, 'Demo', '$2y$10$1WqHlktcbGp0CS3ck1S0ROGWUfz9wbopCMvZqtFheipCXfmi3sGGG', 5, 1);
